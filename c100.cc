...
* @Last Modified time: 2016-03-15 10:16:23
*/
...
int main() {
	...
	std::deque<datapoint> train_data =
		CIFARImporter::importFromFile("data/cifar-100-binary/train.bin", 2);

	std::deque<datapoint> test_data =
		CIFARImporter::importFromFile("data/cifar-100-binary/test.bin", 2);

	// pixels -> softmax : ~17% (10 epochs)
	// pixels -> fc (256) -> fc (256) -> softmax : ~24.8%
	...
	for (size_t e = 0; e < epochs; e++) {
		...
		nn.save_to_files("out/c100_conv_5conv_pad");
